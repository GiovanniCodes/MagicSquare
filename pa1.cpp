...
vector< vector<int> >holdV(int s) {
	...
	for (int i = 0; i < size; i++) {
		...
		for (int j = 0; j < size; j++) {
			//Formula for each odd value
			if (size == 3) {
				v = (((i + j + 1+ (size / 2)) % size) + ((i + 2 * j + 1) % size) + 1)+2;
			}
			else if (size==5){
				v = ((i + j + 1 + (size / 2)) % size) + ((i + 2 * j + 1) % size) + 9;
			}
			else if (size == 7) {
				v = ((i + j + 1 + (size / 2)) % size) + ((i + 2 * j + 1) % size) + 19;
			}
			else if (size == 9) {
				v = ((i + j + 1 + (size / 2)) % size) + ((i + 2 * j + 1) % size) + 33;
			}
			else if (size == 11) {
				v = ((i + j + 1 + (size / 2)) % size) + ((i + 2 * j + 1) % size) + 51;
			}
			else if (size == 13) {
				v = ((i + j + 1 + (size / 2)) % size) + ((i + 2 * j + 1) % size) + 73;
			}
			else if (size == 15) {
				v = ((i + j + 1 + (size / 2)) % size) + ((i + 2 * j + 1) % size) + 99 ;
			}
			row.push_back(v);
